    ...
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Please sign-in to your account and continue to the dashboard.<br>Don't have an
                account? <a href="registration.php">Sign Up</a></p>
            ...
            <form action="login_post.php" method="post">
                ...
                <?php endif; unset($_SESSION['registration_success']); ?>
                <!--========================= success sms end  ==========================-->
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="email" class="form-control m-b-md" id="signInEmail" aria-describedby="signInEmail"
                        ...
                        value="<?= (isset($_SESSION['s_email'])) ? $_SESSION['s_email'] : '' ; unset($_SESSION['s_email']) ?>"
                        name="email">

                    <label for="signInPassword" class="form-label">Password</label>
                    <input type="password" class="form-control" id="myInput" aria-describedby="signInPassword"
                        placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"
                        value="<?= (isset($_SESSION['s_password'])) ? $_SESSION['s_password'] : '' ; unset($_SESSION['s_password']) ?>"
                        name="password">
